...
let GeneratorService = class GeneratorService {
    ...
    buildCommand(cwd, specFile, params) {
        const absoluteSpecPath = path__WEBPACK_IMPORTED_MODULE_4__["resolve"](cwd, specFile);
        const command = Object.entries(Object.assign({ ['input-spec']: absoluteSpecPath }, params)).map(([k, v]) => {
        ...
        const placeholders = {
            ...
            dir: path__WEBPACK_IMPORTED_MODULE_4__["dirname"](absoluteSpecPath),
            path: absoluteSpecPath,
            relDir: path__WEBPACK_IMPORTED_MODULE_4__["dirname"](specFile),
            relPath: specFile,
