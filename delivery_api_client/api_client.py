...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.client_side_validation = None
    ...
    def __call_api(
        ...
        try:
            ...
            e.body = e.body.decode('utf-8') if six.PY3 and not isinstance(e.body, str) else e.body
            raise e
    ...
    def call_api(self, resource_path, method,
	    ...
	    :param callback: callable passed to apply_async and executed when successful result
	    :param err_callback: callable passed to apply_async and executed when exception raised
        :return:
    ...
    def __deserialize_model(self, data, klass):
        ...
        if not hasattr(klass, 'openapi_types') or (not klass.openapi_types and has_discriminator is False):
            return data
