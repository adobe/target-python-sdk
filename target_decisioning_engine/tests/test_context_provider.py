...
class TestContextProvider(unittest.TestCase):
    ...
    def test_create_page_context_non_empty_url(self):
        ...
        self.assertTrue(isinstance(result, PageContext))
        self.assertEqual(result.get("domain"), "Blog.Myfavesite.GeoCities.com")
        self.assertEqual(result.get("domain_lc"), "blog.myfavesite.geocities.com")
        ...
        self.assertEqual(result.get("subdomain"), "Blog")
        self.assertEqual(result.get("subdomain_lc"), "blog")
        self.assertEqual(result.get("topLevelDomain"), "GeoCities.com")
        self.assertEqual(result.get("topLevelDomain_lc"), "geocities.com")
    ...
    def test_create_page_context_applookout(self):
        ...
        self.assertTrue(isinstance(result, PageContext))
        self.assertEqual(result.get("domain"), "stage.applookout.net")
        self.assertEqual(result.get("domain_lc"), "stage.applookout.net")
