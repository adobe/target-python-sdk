...
class TestAttributesProvider(unittest.TestCase):
    ...
    def test_has_appropriate_method_calls(self):
        feature = AttributesProvider(TARGET_DELIVERY_RESPONSE)
        ...
        self.assertDictEqual(feature.get_response(), TARGET_DELIVERY_RESPONSE)

    def test_gets_value_for_single_mbox(self):
        feature_a = AttributesProvider(TARGET_DELIVERY_RESPONSE)
        ...
        feature_b = AttributesProvider(TARGET_DELIVERY_RESPONSE)
    ...
    def test_gets_value_for_multiple_mboxes_at_once(self):
        features = AttributesProvider(TARGET_DELIVERY_RESPONSE)
